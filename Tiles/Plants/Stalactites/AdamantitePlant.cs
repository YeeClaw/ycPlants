...
namespace ycPlants.Tiles.Plants.Stalactites
{
    class AdamantitePlant : ModTile
    {
        ...
        public override void SetDefaults()
        {
            ...
            name.SetDefault("Adamantite Stalactite");

            AddMapEntry(new Color(120, 19, 39), name);
        }
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                Item.NewItem(i * 16, j * 16, 16, 32, ItemID.AdamantiteOre, 2);
                Item.NewItem(i * 16, j * 16, 16, 32, ItemType<Items.Seeds.Stalseeds.AdamantiteSeed>(), 2);
            }
            else if (Main.rand.NextBool())
            {
                Item.NewItem(i * 16, j * 16, 16, 32, ItemType<Items.Seeds.Stalseeds.AdamantiteSeed>(), 1);
            }
