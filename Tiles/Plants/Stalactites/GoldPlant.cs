...
namespace ycPlants.Tiles.Plants.Stalactites
{
    class GoldPlant : ModTile
    {
        ...
        public override void SetDefaults()
        {
            ...
            name.SetDefault("Gold Stalactite");

            AddMapEntry(new Color(217, 210, 28), name);
        }
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                Item.NewItem(i * 16, j * 16, 16, 32, ItemID.GoldOre, 3);
                Item.NewItem(i * 16, j * 16, 16, 32, ItemType<Items.Seeds.Stalseeds.GoldSeed>(), 2);
            }
            else if (Main.rand.NextBool())
            {
                Item.NewItem(i * 16, j * 16, 16, 32, ItemType<Items.Seeds.Stalseeds.GoldSeed>(), 1);
            }
