...
namespace ycPlants.Tiles.Plants.Stalactites
{
    class MythrilPlant : ModTile
    {
        ...
        public override void SetDefaults()
        {
            ...
            name.SetDefault("Mythril Stalactite");

            AddMapEntry(new Color(35, 194, 130), name);
        }
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                Item.NewItem(i * 16, j * 16, 16, 32, ItemID.MythrilOre, 3);
                Item.NewItem(i * 16, j * 16, 16, 32, ItemType<Items.Seeds.Stalseeds.MythrilSeed>(), 2);
            }
            else if (Main.rand.NextBool())
            {
                Item.NewItem(i * 16, j * 16, 16, 32, ItemType<Items.Seeds.Stalseeds.MythrilSeed>(), 1);
            }
