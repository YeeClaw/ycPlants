...
namespace ycPlants.Tiles.Plants.Stalactites
{
    class PlatinumPlant : ModTile
    {
        ...
        public override void SetDefaults()
        {
            ...
            name.SetDefault("Platinum Stalactite");

            AddMapEntry(new Color(130, 174, 191), name);
        }
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                Item.NewItem(i * 16, j * 16, 16, 32, ItemID.PlatinumOre, 3);
                Item.NewItem(i * 16, j * 16, 16, 32, ItemType<Items.Seeds.Stalseeds.PlatinumSeed>(), 2);
            }
            else if (Main.rand.NextBool())
            {
                Item.NewItem(i * 16, j * 16, 16, 32, ItemType<Items.Seeds.Stalseeds.PlatinumSeed>(), 1);
            }
