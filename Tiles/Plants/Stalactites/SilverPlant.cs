...
namespace ycPlants.Tiles.Plants.Stalactites
{
    class SilverPlant: ModTile
    {
        ...
        public override void SetDefaults()
        {
            ...
            name.SetDefault("Silver Stalactite");

            AddMapEntry(new Color(216, 230, 235), name);
        }
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                Item.NewItem(i * 16, j * 16, 16, 32, ItemID.SilverOre, 3);
                Item.NewItem(i * 16, j * 16, 16, 32, ItemType<Items.Seeds.Stalseeds.SilverSeed>(), 2);
            }
            else if (Main.rand.NextBool())
            {
                Item.NewItem(i * 16, j * 16, 16, 32, ItemType<Items.Seeds.Stalseeds.SilverSeed>(), 1);
            }
