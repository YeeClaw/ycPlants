...
namespace ycPlants.Tiles.Plants.Stalactites
{
    class TinPlant : ModTile
    {
        ...
        public override void SetDefaults()
        {
            ...
            name.SetDefault("Tin Stalactite");

            AddMapEntry(new Color(172, 176, 114), name);
        }
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                Item.NewItem(i * 16, j * 16, 16, 32, ItemID.TinOre, 3);
                Item.NewItem(i * 16, j * 16, 16, 32, ItemType<Items.Seeds.Stalseeds.TinSeed>(), 2);
            }
            else if (Main.rand.NextBool())
            {
                Item.NewItem(i * 16, j * 16, 16, 32, ItemType<Items.Seeds.Stalseeds.TinSeed>(), 1);
            }
