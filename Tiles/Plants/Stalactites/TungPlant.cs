...
namespace ycPlants.Tiles.Plants
{
    class TungPlant : ModTile
    {
        ...
        public override void SetDefaults()
        {
            ...
            name.SetDefault("Tungsten Stalactite");
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            if (nearestB <= 106 * 106 && nearestT <= 106 * 106 && stage == PlantStage.Grown)
            {
                ...
                Item.NewItem(i * 16, j * 16, 16, 32, ItemType<Items.Seeds.TungSeed>(), 2);
            }
            else if (Main.rand.NextBool())
            {
                Item.NewItem(i * 16, j * 16, 16, 32, ItemType<Items.Seeds.TungSeed>(), 1);
            }
